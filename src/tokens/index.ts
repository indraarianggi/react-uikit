 ...
 * Design Tokens
 *
 * These tokens are the single source of truth for design decisions
 * and are consumed by both TailwindCSS and component styles.
 */
...
export const typography = {
  ...
  fontSize: {
    ...
    '7xl': ['4.5rem', { lineHeight: '1' }] as [string, { lineHeight: string }], // 72px
    '8xl': ['6rem', { lineHeight: '1' }] as [string, { lineHeight: string }], // 96px
    '9xl': ['8rem', { lineHeight: '1' }] as [string, { lineHeight: string }], // 128px
  },
...
// Export individual token groups for easier importing
export {
  ...
  timingFunction as tokenTimingFunction,
}
